...
<div class="container">
<div id="rightSplit" class="rightSplit grid-3-3">
...
<nav class="tabNav">
  <ul>
    ...
    <?php
      ...
      ?>
      <li><a href="#contest-overview" class="link<?php if($_GET['tab']=='') echo ' active';?>">Details</a></li>
      <li><a href="#viewRegistrant" class="link">Registrants</a></li>
      <?php
      ...
      ?>
      <?php
      if (strpos($contest->currentStatus, 'Completed') !== FALSE):
      ?>
		<li><a id="submissionTabLink" href="#submissions" class="link">Submissions</a></li>
	  <?php
	  elseif (strpos($contest->currentStatus, 'Review') !== FALSE):
		?>
...
<nav class="tabNav firstTabNav designSecondTabNav mobile hide">
  <ul>
    ...
    <li><a href="#checkpoints" class="link">Checkpoints</a></li>
	  ...
	  if (strpos($contest->currentStatus, 'Completed') !== FALSE):
	  ?>
		<li><a id="submissionTabLinkMobile" href="#submissions" class="link">Submissions</a></li>
	  <?php
	  elseif (strpos($contest->currentStatus, 'Review') !== FALSE):
		?>
		<li><span class="inactive">Submissions</span></li>
...
<!-- Just show on full column tab, not on 2 column tab -->
<div id="rightTitleOnFull" class="hide">
